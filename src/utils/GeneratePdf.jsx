...
const GeneratePdf = ({ data }) => {
  ...
  const handleGeneratePdf = () => {
    ...
    doc.addImage(PdfLogo, "PNG", 0, -17, pageWidth, (pageWidth / 2 )* 3);
    ...
    yPosition += 10;
    doc
      .text(marginLeft, yPosition, `Reservation & Payment Support: cca@navan.com `)
      .setFontSize(10);
    yPosition += 10;
    doc
      .text(
        marginLeft,
        yPosition,
        `-	Please use the card number above to process payment for this reservation. `
      )
      .setFontSize(10);
    yPosition += 10;
    doc
      .text(
        marginLeft,
        yPosition,
        `-	Guest may be responsible for any incidental charges if not noted in allowed `
      )
      .setFontSize(10);
    yPosition += 10;
    doc
      .text(marginLeft, yPosition, `-	Process any cancellation fees or No Shows as appropriate.`)
      .setFontSize(10);
    yPosition += 10;
    doc
      .text(
        marginLeft,
        yPosition,
        `-	For questions processing this card please email cca@navan.com `
      )
      .setFontSize(10);
    yPosition += 10;
