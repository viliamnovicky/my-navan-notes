...
function NewCCA({taxId, setTaxId, expNumber, setExpNumber, cardNumber, setCardNumber, cvc, setCvc, cardName, setCardName, companyAddress, setCompanyAddress, confirmation, setConfirmation, guestName, hotelName, setGuestName, setHotelName, arrival, setArrival,departure, setDeparture, companyName, setCompanyName, setIsOpenCCAForm }) {
  const data  = {
    expNumber,
    cardNumber,
    cvc,
